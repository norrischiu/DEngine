	...
	: DE::AnimationStateMachine(animController)
{
	...
	((DE::BlendTree*)hWalkBTree.Raw())->m_vClipnames.Add("walk");
	((DE::BlendTree*)hWalkBTree.Raw())->m_vWeightings.Add(0);
	((DE::BlendTree*)hWalkBTree.Raw())->m_vClipnames.Add("strafe_right");
	((DE::BlendTree*)hWalkBTree.Raw())->m_vWeightings.Add(1);
	((DE::BlendTree*)hWalkBTree.Raw())->m_vClipnames.Add("walk_back");
	((DE::BlendTree*)hWalkBTree.Raw())->m_vWeightings.Add(2);
	((DE::BlendTree*)hWalkBTree.Raw())->m_vClipnames.Add("strafe_left");
	((DE::BlendTree*)hWalkBTree.Raw())->m_vWeightings.Add(3);
	...
	((DE::BlendTree*)hRunBTree.Raw())->m_vClipnames.Add("run");
	((DE::BlendTree*)hRunBTree.Raw())->m_vWeightings.Add(0);
	((DE::BlendTree*)hRunBTree.Raw())->m_vClipnames.Add("run_right");
	((DE::BlendTree*)hRunBTree.Raw())->m_vWeightings.Add(1);
	((DE::BlendTree*)hRunBTree.Raw())->m_vClipnames.Add("run_back");
	((DE::BlendTree*)hRunBTree.Raw())->m_vWeightings.Add(2);
	((DE::BlendTree*)hRunBTree.Raw())->m_vClipnames.Add("run_left");
	((DE::BlendTree*)hRunBTree.Raw())->m_vWeightings.Add(3);
	...
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vClipnames.Add("dodge_left");
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vWeightings.Add(0);
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vClipnames.Add("dodge_right");
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vWeightings.Add(1);
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vClipnames.Add("dodge_forward");
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vWeightings.Add(2);
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vClipnames.Add("dodge_backward");
	((DE::BlendTree*)hDodgeBTree.Raw())->m_vWeightings.Add(3);
