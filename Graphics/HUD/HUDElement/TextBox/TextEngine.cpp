...
{
	if (!m_Font && !LoadFontData("../Graphics/HUD/HUDElement/TextBox/font_data.txt")) {
...
MeshData* TextEngine::CreateTextMeshData(const char* sentence) {
	...
	textPass->AddTexture(new Texture(Texture::SHADER_RESOURCES, 1, "../Graphics/HUD/HUDElement/TextBox/font.dds"));
