...
PostProcessEffect::PostProcessEffect()
{
	...
	ReflectionPass->SetVertexShader("Shaders/VS_gbuffer.hlsl");
	ReflectionPass->SetPixelShader("Shaders/PS_SSReflection_ppe.hlsl");
	...
	BlurHPass->SetVertexShader("Shaders/VS_gbuffer.hlsl");
	BlurHPass->SetPixelShader("Shaders/PS_PPE_BlurH.hlsl");
	...
	BlurVPass->SetVertexShader("Shaders/VS_gbuffer.hlsl");
	BlurVPass->SetPixelShader("Shaders/PS_PPE_BlurV.hlsl");
